...
public class DBUtil {
	public static String sanitizeInput(String inputString) {
		...
		String sanitizedString = inputString.replaceAll("(?i)\\b(SELECT|INSERT|UPDATE|DELETE|DROP|CREATE|ALTER|TRUNCATE)\\b", "")
				.replaceAll("[;\'\"`]", "");
...
**
	...
	public static long storeFeedback(String name, String email, String subject, String comments) {
		try{
			...
			subject = Encode.forHtml(subject);
			comments = Encode.forHtml(comments);
