...
<div id="wrapper" style="width: 99%;">
	...
	<td valign="top" colspan="3" class="bb">
		...
		<%
			...
			// If the current user is not an admin, display an error message and exit
			if (!isAdmin) {
				response.setStatus(HttpServletResponse.SC_FORBIDDEN); // Set HTTP 403 Forbidden status
				out.print("<h1>Access Denied</h1>");
				out.print("<p>You are not authorized to access this page.</p>");
				return; // Exit from the page
			}
		%>
		...
		<%--		// we deleted the comment found here--%>
